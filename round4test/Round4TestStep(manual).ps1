...
invoke-atomictest T1185A -testnumber 1 -ExecutionLogPath $ExecutionLogPath #manual
pause

#------------------------------------------------------------
#Command and Control - Web Service: Bidirectional Communication(T1102.002A)
invoke-atomictest T1102.002A -testnumber 1 -ExecutionLogPath $ExecutionLogPath #manual
pause
