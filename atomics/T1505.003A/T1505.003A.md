...
- [Atomic Test #2 - Web Shell Written to Disk](#atomic-test-2---web-shell-written-to-disk)


<br/>

## Atomic Test #2 - Web Shell Written to Disk
...
#### Dependencies:  Run with `GUI`!
##### Description: Web shell must installed iis


##### Check Prereq Commands:
```
웹브라우저에서 localhost 경로 찾아가기
```
##### Get Prereq Commands:
```
1. Start Server Manager 실행
2. Add roles and Features 클릭
3. Add roles and Features Wizard 진행
3. Select Server roles 항목에서 Web Server (IIS) 선택
```
