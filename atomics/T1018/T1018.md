...
|------|-------------|------|---------------|
| target_domain | Domain to query for domain controllers | String | contoso|
...
| Name | Description | Type | Default Value | 
|------|-------------|------|---------------|
| user_name | username including domain. | string | contoso&#92;user|
| acct_pass | Account password. | string | At0micStrong|
| host_name | hostname or ip address to connect to. | string | 192.168.204.100|
