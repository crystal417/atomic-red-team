...
|------|-------------|------|---------------|
| user_name | username | string | USER|
| ntlm | ntlm hash | string | 7a0c0f0bd4f14d50f17227cd0206a385|
| domain | domain | string | contoso|
...
| ntlm | command | string |  7a0c0f0bd4f14d50f17227cd0206a385|
| domain | domain | string | contoso|
